...
def concat(file_1, file_2, output_file):
    # output_file = "cityscapes_2020-01-12_550.log" 
    f1=open(file_1,"r")
    f2=open(file_2,"r")
    ff1 = f1.readlines()
    ff2 = f2.readlines()
...
if __name__ == "__main__":
    # concat("yolact_base_cityscapes_20200305.log", "yolact_base_cityscapes_2020-03-11.log", "yolact_base_cityscapes_20200311.log")
    print("Reading......")
    logfile = open("cityscapes_2020-01-12_550.log", "r")
    ...
    plt.subplot(4, 1, 4)
    plt.plot(x, s_loss, color="purple", linewidth=1)
